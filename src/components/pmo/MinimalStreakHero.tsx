...
export const MinimalStreakHero: React.FC<MinimalStreakHeroProps> = ({
  ...
  return (
    <Card variant="glass" className="p-6 md:p-8 space-y-6 text-center border-slate-800/60 shadow-sm">
      {/* Sleek Minimalist Central Ring */}
      <div className="relative w-36 h-36 md:w-44 md:h-44 mx-auto rounded-full bg-slate-950/80 border border-slate-800 flex flex-col items-center justify-center p-4">
        <div className="flex items-center gap-1 text-amber-400 font-medium text-xs mb-0.5">
          <Flame className="w-4 h-4 fill-amber-400" />
          <span>Active Streak</span>
        </div>
        <span className="text-4xl md:text-5xl font-black text-slate-100 font-mono tracking-tight">
          {currentStreak}
        </span>
