...
export const GuardingGazeCard: React.FC<GuardingGazeCardProps> = ({ cleanGazeDays }) => {
  return (
    <Card variant="gold" className="p-4 border-amber-500/30">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1 bg-amber-950/80 px-2 py-0.5 rounded-full border border-amber-500/40 text-xs font-mono font-bold text-amber-300">
          <ShieldCheck className="w-3.5 h-3.5" />
          {cleanGazeDays} Days Guarded
        </div>
      </div>
      <p className="text-xs text-amber-100/90 mt-2 font-serif italic">
