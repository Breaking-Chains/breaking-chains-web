      ...
      <div className="w-full space-y-1.5 text-left">
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            type={type}
            className={cn(
              'w-full bg-slate-900/90 border border-slate-800 rounded-xl px-4 py-3 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 transition-all min-h-[48px]',
              icon && 'pl-10',
