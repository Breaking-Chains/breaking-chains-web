...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-slate-950/80 backdrop-blur-md animate-fade-in">
      <div
        className={cn(
          'w-full bg-slate-950 border border-slate-800 shadow-2xl rounded-t-3xl sm:rounded-2xl flex flex-col max-h-[92vh] sm:max-h-[85vh] overflow-hidden transition-all transform duration-300',
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-800/80 bg-slate-900/50">
          ...
          <button
            onClick={onClose}
            className="p-2 text-slate-400 hover:text-white hover:bg-slate-800 rounded-full transition-colors ml-auto min-h-[44px] min-w-[44px] flex items-center justify-center"
