...
export const MobileLayout: React.FC<MobileLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex selection:bg-emerald-500/30">
      ...
      <div className="flex-1 flex flex-col min-h-screen relative w-full overflow-x-hidden">
        ...
        <header className="hidden md:flex items-center justify-between px-8 py-4 bg-slate-950/80 backdrop-blur-md border-b border-slate-800/80 sticky top-0 z-30">
          <div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-rose-600 to-amber-600 hover:from-rose-500 hover:to-amber-500 text-white font-bold text-xs rounded-xl shadow-lg shadow-rose-950/40 animate-pulse-glow transition-all"
            >
