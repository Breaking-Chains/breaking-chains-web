                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-4 bg-white dark:bg-slate-950/70 p-3 rounded-xl border border-slate-100 dark:border-slate-850 text-xs">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-1 mt-0.5 text-emerald-700 dark:text-emerald-455 font-black font-mono">
            ...
            <div className="space-y-4">
              ...
              {requests.length === 0 ? (
                <Card variant="glass" className="p-8 text-center space-y-2 border-slate-200 dark:border-slate-900 bg-slate-100/20 dark:bg-slate-950/20">
                  <p className="text-xs text-slate-505 dark:text-slate-400 font-medium italic">No pending connection requests.</p>
                </Card>
              ) : (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {requests.map((req) => (
                    <Card key={req.id} variant="gold" className="p-3.5 space-y-3 border-amber-500/20 shadow-xs">
                      <div className="flex items-start justify-between">
                        ...
                        <span className="text-[9px] text-slate-505 font-medium">{req.date}</span>
                      </div>
                      <div className="flex items-center justify-between gap-2 pt-1">
                        ...
                        <div className="flex gap-1.5 shrink-0">
                          ...
                          <button
                            ...
                            className="p-1 rounded-lg bg-rose-50 hover:bg-rose-105 dark:bg-rose-950 dark:hover:bg-rose-900 border border-rose-305 dark:border-rose-700 text-rose-700 dark:text-rose-455 cursor-pointer"
